#  1. make file or folder for project then select interpreter from bottom right click then download vnv 3.12.64
#  2. then open terminal and install speechrecognition  for speech to text and pyaudio 3.install steuptools
#  3. aslo install pyttsx3 :- for text to speech 
...
if __name__ == "__main__":
    ...
    while True :  #Creates an infinite loop to continuously listen for commands.
        ...
        if query == "none" :
            ...
            except wikipedia.exceptions.PageError : # the line for when wikipedia will not find pages or some issue 
